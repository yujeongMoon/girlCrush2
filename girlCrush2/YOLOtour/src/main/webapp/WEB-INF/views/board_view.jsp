               ...
               <div class="col-12 col-lg-5">
                  <div class="single_product_desc">
                     ...
                     action="<c:url value='/travelboards/view/addcart/${travel.travelId }'/>">
                        <button type="submit" name="travelCart" class="btn btn-warning"
                          onclick="alert('장바구니에 등록되었습니다')">Add to cart</button>
                     </form>
                     <br>
                     <form class="cart clearfix" method="post">
                        <a href="/payment/${travel.travelId }" type="submit"
                           name="payment" class="btn btn-warning" style="border: 0;">Pay Now</a>
                     </form>
                     <br>
                     <a href="/travelboards" class="btn btn-warning" style="position: absolute; right: 0;">List</a>
